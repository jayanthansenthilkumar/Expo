...
<head>
    ...
    <title>Project Reviews | SPARK'26</title>
    ...
    <div class="app-container">
        ...
        <aside class="d-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="advisorReviews.php" class="menu-item active"><i class="ri-clipboard-line"></i> Project Reviews</a>
            ...
            <div class="d-content">
                ...
                <div class="welcome-card" style="min-height: 150px;">
                    <div class="welcome-text">
                        ...
                        <p>Manage project reviews here.</p>
                    </div>
                </div>

                <div style="text-align:center; padding: 4rem; color: var(--text-muted);">
                    <i class="ri-clipboard-line" style="font-size: 4rem; opacity: 0.2; margin-bottom: 1rem;"></i>
                    <h3>Project Reviews Module</h3>
