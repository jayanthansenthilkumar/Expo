    ...
    <div class="app-container">
        ...
        <aside class="d-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="hodFaculty.php" class="menu-item active"><i class="ri-user-settings-line"></i> Faculty</a>
