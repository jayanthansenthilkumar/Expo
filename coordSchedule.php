    ...
    <div class="app-container">
        ...
        <aside class="d-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="coordSchedule.php" class="menu-item active"><i class="ri-calendar-line"></i> Schedule</a>
            ...
            <div class="d-content">
                ...
                <div class="welcome-card" style="min-height: 150px;">
                    <div class="welcome-text">
                        <h2>Schedule</h2>
                        <p>Manage schedule here.</p>
                    </div>
                </div>

                <div style="text-align:center; padding: 4rem; color: var(--text-muted);">
                    <i class="ri-calendar-line" style="font-size: 4rem; opacity: 0.2; margin-bottom: 1rem;"></i>
