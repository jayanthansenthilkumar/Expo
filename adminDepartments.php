    ...
    <div class="app-container">
        ...
        <aside class="d-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="adminDepartments.php" class="menu-item active"><i class="ri-building-line"></i> Departments</a>
        ...
        <main class="d-main">
            ...
            <div class="d-content">
                ...
                <div style="text-align:center; padding: 4rem; color: var(--text-muted);">
                    <i class="ri-building-line" style="font-size: 4rem; opacity: 0.2; margin-bottom: 1rem;"></i>
